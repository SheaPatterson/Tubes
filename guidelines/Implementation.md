...
- [ ] 1. Set up project foundation, types, and constants
    
    - [~] 1.1 Create core TypeScript type definitions
    ...
    - [~] 1.2 Create amp model and FX pedal data constants
        ...
        - Create `src/data/fx-pedals.ts` defining all FX pedals under Brand_Rename identities (MAC, KING, Manhattan, TOKYO) with controls, categories, and tier requirements
    ...
    - [~] 1.4 Set up Quicksand font and global design tokens
...
- [ ] 2. Implement subscription tier access control and serialization logic
    
    - [~] 2.1 Implement subscription tier access control module
    ...
    - [~] 2.2 Write property test for subscription tier access control
        
        - **Property 1: Subscription tier access control**
        - **Validates: Requirements 1.2, 1.3, 1.4, 6.7**
    - [~] 2.3 Implement tone stack serialization and deserialization
    ...
    - [~] 2.4 Write property test for tone stack serialization round-trip
        
        - **Property 3: Tone stack serialization round-trip**
        - **Validates: Requirements 25.1, 25.2, 25.3**
    - [~] 2.5 Write property test for FX pedal chain serialization round-trip
        
        - **Property 4: FX pedal chain serialization round-trip**
        - **Validates: Requirements 25.5, 25.6, 6.6**
    - [~] 2.6 Write property test for invalid tone stack JSON error identification
        
        - **Property 5: Invalid tone stack JSON error identification**
        - **Validates: Requirements 25.4**
    - [~] 2.7 Implement parameter clamping and validation utilities
    ...
    - [~] 2.8 Write property test for parameter value clamping
        
        - **Property 12: Parameter value clamping**
        - **Validates: Requirements 26.5**
    - [~] 2.9 Write property test for preamp tube count validation
        
        - **Property 9: Preamp tube count validation**
        - **Validates: Requirements 4.1**
    - [~] 2.10 Write property test for model and pedal control completeness
        
        - **Property 10: Model and pedal control completeness**
        - **Validates: Requirements 3.6, 6.3**
    - [~] 2.11 Write property test for brand rename consistency
...
- [ ] 4. Implement Convex backend schema and functions
    ...
    - [~] 4.1 Create Convex schema definition
    ...
    - [~] 4.2 Implement Convex signal chain query and mutation functions
    ...
    - [~] 4.3 Implement Convex subscription and access control functions
    ...
    - [~] 4.4 Implement Convex user authentication functions
    ...
    - [~] 4.7 Write property test for database referential integrity
        
        - **Property 15: Database referential integrity**
        - **Validates: Requirements 20.4**
    - [~] 4.8 Write property test for saved signal chain list sorting
...
- [ ] 6. Implement DSP engine and AudioWorklet processors
    ...
    - [~] 6.1 Create AudioWorklet processor base and input/output processors
    ...
    - [~] 6.2 Implement preamp tube processor
    ...
    - [~] 6.3 Write property test for cumulative preamp gain staging
        
        - **Property 6: Cumulative preamp gain staging**
        - **Validates: Requirements 3.3, 4.2, 4.4**
    - [~] 6.4 Implement amplifier processor (tone stack + channel)
    ...
    - [ ] 6.5 Implement power amp processor
    ...
    - [ ] 6.6 Write property test for power amp drive compression monotonicity
        
        - **Property 7: Power amp drive compression monotonicity**
        - **Validates: Requirements 3.5, 5.3, 5.4**
    - [ ] 6.7 Write property test for power amp tube type parameter validity
        
        - **Property 8: Power amp tube type parameter validity**
        - **Validates: Requirements 5.2, 5.5**
    - [ ] 6.8 Implement FX pedal processor
    ...
    - [ ] 6.9 Implement cabinet processor with IR convolution
    ...
    - [ ] 6.10 Write property test for microphone configuration determinism
        
        - **Property 16: Microphone configuration determinism**
        - **Validates: Requirements 7.8, 8.3**
    - [ ] 6.11 Implement Signal Chain Manager
    ...
    - [ ] 6.12 Write property test for signal chain processing order invariant
...
- [ ] 8. Implement skeuomorphic UI controls and amp/FX renderers
    ...
    - [ ] 8.1 Create rotary knob control component
    ...
    - [ ] 8.2 Create toggle switch and slider control components
        ...
        - _Requirements: 14.4, 14.5_
    - [ ] 8.3 Create parameter context menu component
    ...
    - [ ] 8.4 Write property test for context menu option completeness
        
        - **Property 13: Context menu option completeness**
        - **Validates: Requirements 14.5, 26.1, 26.2, 26.3**
    - [ ] 8.5 Create amp model renderer component
    ...
    - [ ] 8.6 Create FX pedal component and pedal board with drag-and-drop
    ...
    - [ ] 8.7 Create cabinet and microphone position UI
...
- [ ] 9. Implement service modules (AI, MIDI, recording, offline)
    ...
    - [ ] 9.1 Implement AI Engine service
    ...
    - [ ] 9.2 Implement MIDI Manager service
    ...
    - [ ] 9.3 Implement Recording Engine service
    ...
    - [ ] 9.4 Implement Offline Manager service
    ...
    - [ ] 9.5 Implement Audio Interface Manager
...
- [ ] 11. Implement application pages and layouts
    ...
    - [ ] 11.1 Create primary application layout with signal chain view
    ...
    - [ ] 11.2 Create main signal chain page
    ...
    - [ ] 11.3 Create Live Performance page
    ...
    - [ ] 11.4 Create Saved Signal Chains page
